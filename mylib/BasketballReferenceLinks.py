class BasketBallReferenceLinks:
    ...
    team_ratings = r'https://www.basketball-reference.com/leagues/NBA_{year}_ratings.html#ratings'
    player_game_log = r'https://www.basketball-reference.com/{suffix}/gamelog/{year}#{type}'
    team_roster = r'https://www.basketball-reference.com/teams/{team_abv}/{year}.html#roster'
    team_names = ['Atl', 'Bos', 'Brk', 'Cho', 'Chi', 'Cle', 'Dal', 'Den', 'Det', 'Gsw', 'Hou', 'Ind', 'LAC',
